...
public class TimeScale
{
	...
	{	
		...
		if (astro.getYear() < DST_START_YEAR) return 0;
...
*/			
			...
			BigDecimal JD = TimeScale.getExactJD(time, observer, eph, SCALE.LOCAL_TIME);
			System.out.println("JD  LT: " + JD);
			JD = TimeScale.getExactJD(time, observer, eph, SCALE.UNIVERSAL_TIME_UT1);
			System.out.println("JD UT1: " + JD);
			JD = TimeScale.getExactJD(time, observer, eph, SCALE.UNIVERSAL_TIME_UTC);
			System.out.println("JD UTC: " + JD);
			JD = TimeScale.getExactJD(time, observer, eph, SCALE.TERRESTRIAL_TIME);
			System.out.println("JD  TT: " + JD);
			JD = TimeScale.getExactJD(time, observer, eph, SCALE.BARYCENTRIC_DYNAMICAL_TIME);
			...
			JD = TimeScale.getExactJD(time2, observer, eph, SCALE.LOCAL_TIME);
			System.out.println("JD  LT: " + JD);
			JD = TimeScale.getExactJD(time2, observer, eph, SCALE.UNIVERSAL_TIME_UT1);
			System.out.println("JD UT1: " + JD);
			JD = TimeScale.getExactJD(time2, observer, eph, SCALE.UNIVERSAL_TIME_UTC);
			System.out.println("JD UTC: " + JD);
			JD = TimeScale.getExactJD(time2, observer, eph, SCALE.TERRESTRIAL_TIME);
			System.out.println("JD  TT: " + JD);
			JD = TimeScale.getExactJD(time2, observer, eph, SCALE.BARYCENTRIC_DYNAMICAL_TIME);
			System.out.println("JD TDB: " + JD);

			System.out.println("Using LT as input");
			JD = TimeScale.getExactJD(time, observer, eph, SCALE.LOCAL_TIME);
			astro = new AstroDate(JD);
			...
			chart.getChartElement().series[0].regressionType = REGRESSION.POLYNOMIAL;
