...
/**
  ...
  */
	public CFormat(String s) throws JPARSECException {
		width = 0;
		precision = -1;
		pre = "";
		post = "";
		...
		while (parse_state == 0) {
			if (i >= length)
				...
				if (i < length - 1) {
					...
					throw new JPARSECException("Bad format.");
			} else
				pre = pre + s.charAt(i);
			i++;
		}
	 ...
	 * @throws JPARSECException if bad format.
	 */
	public static void print(java.io.PrintStream s, String fmt, double x) throws JPARSECException {
		s.print(new CFormat(fmt).form(x));
	}
	 ...
	 * @throws JPARSECException if bad format.
	 */
	public static void print(java.io.PrintStream s, String fmt, long x) throws JPARSECException {
		s.print(new CFormat(fmt).form(x));
	}
	 ...
	 * @throws JPARSECException if bad format.
	 */
	public static void print(java.io.PrintStream s, String fmt, char x) throws JPARSECException {
		s.print(new CFormat(fmt).form(x));
	}
	 ...
	 * @throws JPARSECException if bad format.
	 */
	public static void print(java.io.PrintStream s, String fmt, String x) throws JPARSECException {
		s.print(new CFormat(fmt).form(x));
	}
	...
	public static double atof(String s) {
		...
		while (i < s.length()) {
			...
			if ('0' <= ch && ch <= '9') {
				...
				return FastMath.multiplyBy10ToTheX(sign * r, (int)e);
			} else
				return sign * r;
			i++;
		}
	 ...
	 */
	public String form(double x) throws JPARSECException {
		String r;
		if (precision < 0)
			precision = 6;
		int s = 1;
		...
		if (fmt == 'f')
			...
			throw new JPARSECException("Bad argument '"+x+"'");
	 ...
	 * @throws JPARSECException if bad format.
	 */
	public String form(long x) throws JPARSECException {
		String r;
		int s = 0;
		if (fmt == 'd' || fmt == 'i') {
			s = 1;
			...
			throw new JPARSECException("Bad format '"+fmt+"'");
	 ...
	 * @throws JPARSECException if bad format.
	 */
	public String form(char c) throws JPARSECException {
		if (fmt != 'c')
			throw new JPARSECException("Format must be 'c'");
	 ...
	 * @throws JPARSECException if bad format.
	 */
	public String form(String s) throws JPARSECException {
		if (fmt != 's')
			throw new JPARSECException("Format must be 's'");
		if (precision >= 0)
