...
public class Spacecraft
{
	...
	{
		System.out.println("Probes Test");
		...
		try
		{
			...
			String name = getName(probe) + " / " + getPhase(probe) + " / " + Spacecraft.searchProbe(getFullName(probe));
			System.out.println("JD " + JD + " / " + name);

			System.out.println("Horizons to JPARSEC:");
			String horizons[] = new String[] // Spirit
			...
			OrbitalElement orbit = OrbitEphem.getOrbitalElements(TARGET.VENUS, astro.jd());
