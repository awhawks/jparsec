...
public class ExtraterrestrialObserverElementTest {
    ...
    public static void main(String args[]) throws Exception {
        ...
        double pos[] = Ephem.eclipticToEquatorial(PlanetEphem.getHeliocentricEclipticPositionJ2000(TimeScale.getJD(time, observer, eph, TimeElement.SCALE.BARYCENTRIC_DYNAMICAL_TIME), Target.TARGET.JUPITER), Constant.J2000, eph);
