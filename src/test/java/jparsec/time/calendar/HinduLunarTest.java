...
public class HinduLunarTest {
    ...
    public static void main(String args[]) {
        System.out.println("Hindu Lunar Test");

        int jd = 2451545;
        HinduLunar h = new HinduLunar(jd);
        System.out.println("JD " + jd + " = " + h.year + "/" + h.month + "/" + h.leapMonth + "/" + h.day + "/" + h.leapDay);

        HinduLunar h2 = new HinduLunar(h.year, h.month, h.leapMonth, h.day, h.leapDay);
        System.out.println("JD " + h2.toJulianDay() + " = " + h2.year + "/" + h2.month + "/" + h2.leapMonth + "/" + h2.day + "/" + h2.leapDay);
