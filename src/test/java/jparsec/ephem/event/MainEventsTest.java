...
public class MainEventsTest {
    ...
    public static void main(String args[]) throws Exception {
        ...
        SimpleEventElement see = null;
        AstroDate astro = new AstroDate(2015, 5, 15);
...
/*
        ...
        see = MainEvents.getPlanetaryEvent(TARGET.MARS, astro.jd(), SimpleEventElement.EVENT.PLANET_MAXIMUM_ELONGATION, MainEvents.EVENT_TIME.NEXT);
