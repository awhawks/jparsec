...
public class SatelliteEphemTest {
    ...
    public static void main(String args[]) {
        ...
        try {
            AstroDate astro = new AstroDate(2011, AstroDate.JULY, 4, 13, 32, 18.732);
...
/*                    time = new TimeElement(astro, SCALE.UNIVERSAL_TIME_UTC);
                    ...
                    EphemElement sunEphem = Ephem.getEphemeris(time, observer, eph, false);
                    ...
                    double ast = SiderealTime.greenwichMeanSiderealTime(time, observer, eph);
...
//            System.out.println("quickSearch "+ SatelliteEphem.getBestQuickSearch(SatelliteEphem.getArtificialSatelliteOrbitalElement(index), 15.0 * Constant.DEG_TO_RAD)/time_step);
            ...
            for (int n = 0; n < nmax; n++) {
                ...
                ArrayList<Object[]> flares = SatelliteEphem.getNextIridiumFlares(time, observer, eph,
                        SatelliteEphem.getArtificialSatelliteOrbitalElement(n), min_elevation, maxDays, current, precision);
                if (flares != null) {
