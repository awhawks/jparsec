...
public class MeanValueTest {
    ...
    public static void main(String args[]) {
        ...
        try {
            double x[] = new double[] { 0.007225092328677015, 0.006792142191533583, 0.00721567921149969743, 0.0066994947683284005, 0.0072940980534992655 };
            double dx[] = new double[] { 0.1471154725454545, 0.1471154725454545, 0.052060499327602934, 0.0, 0.002431366018643544 };
