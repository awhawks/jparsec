...
public class CreateChartTest {
    ...
    public static void main(String[] args) throws JPARSECException {
        ...
        double p[] = p = ch1.getJava2DUnits(1, 2);
        ...
        g.draw(AWTGraphics.rotateShape(new Ellipse2D.Double(2 - rx * 0.5, 5 - ry * 0.5, rx, ry), -45 * Constant.DEG_TO_RAD)); // Rotate 45Âº using the Graphics2D transform
        g.fill(AWTGraphics.rotateShape(g, new Ellipse2D.Double(2 - rx * 0.5, 5 - ry * 0.5, rx, ry), -45 * Constant.DEG_TO_RAD)); // Rotate 45Âº using the original transform
        g.drawLine(2, 5, 1, 2);
        p1.show("");
...
//        ch1bis.showChart(true);
        ...
        ChartSeriesElement chartSeries2 = new ChartSeriesElement(vx,
                y1, null, null,
                "dM/dt = 10^{-3} M_{@SUN}/aÃ±o", true, Color.BLACK, ChartSeriesElement.SHAPE_EMPTY,
                ChartSeriesElement.REGRESSION.NONE);
        ...
        ChartElement chart4 = new ChartElement(series, ChartElement.TYPE.XY_CHART,
                ...
                "AcreciÃ³n y tiempo de Kelvin-Helmholtz",
                "Masa de la estrella (M_{@SUN})", "Tiempo (aÃ±os)", false, 802, 482);
        ...
        chart4.series[1].pointers = new String[] {"10 dM/dt = 10^{-3} M_{@SUN}/aÃ±o"};
        chart4.series[2].pointers = new String[] {"10 dM/dt = 10^{-4} M_{@SUN}/aÃ±o"};
        chart4.series[3].pointers = new String[] {"10 dM/dt = 10^{-5} M_{@SUN}/aÃ±o"};
