...
public class GeneralQueryTest {
    ...
    public static void main(String args[]) {
        try {
            ...
            String query = GeneralQuery.getQueryToSkyView("M31",
                    GeneralQuery.SKYVIEW_SURVEY.IRAS100, 2, width, false, true,
            ...
            width = 500;
            int height = 500;
            query = GeneralQuery.getQueryToUSGSAstroGeologyMapServer(
                    Target.TARGET.MARS, width, height,
                    new double[] { 60, -30, 160, 70 },
