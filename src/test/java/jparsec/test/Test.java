...
public class Test
{
	...
	public static void main(String args[]) {
		...
		TEST testsToExecute = TestElement.TEST.ALL;
		...
		try {
			String file[] = DataSet.arrayListToStringArray(ReadFile.readResource("jparsec/test/tests.txt", ReadFile.ENCODING_ISO_8859));
