...
public class Spectrum30m implements Serializable
{
    ...
    public boolean equals(Object o)
    {
    	...
    	if (!Arrays.equals(this.data, s.data)) equals = false;
    	return equals;
    }
    ...
    throws JPARSECException {
        ...
        map.put(Gildas30m.TELES, new Parameter(teles, Gildas30m.LINE_DESC));
        ...
        map.put(Gildas30m.REF_CHAN, new Parameter((double)refch, Gildas30m.REF_CHAN_DESC));
		...
		try {
	        ...
	        int projection = Gildas30m.PROJECTION_RADIO, veltype = 1, mode = 1;
		   	for (int i=0; i<out.length; i++) {
		        ...
		        out[i].map.put(Gildas30m.REF_CHAN, new Parameter((double)refch, Gildas30m.REF_CHAN_DESC));
