...
public class CreateChartTest {
    ...
    public static void main(String[] args) throws JPARSECException {
        ...
        SimpleChartElement chart1 = new SimpleChartElement(
                ChartElement.TYPE.XY_CHART, ChartElement.SUBTYPE.XY_SCATTER, new double[] { 1, 2, 3 }, new double[] { 2, 5, 8 },
                "CHART 1", "X_LABEL", "Y_LABEL", "LEGEND", true, false, 400, 300);
        ...
        // Rotate 45 &ordm; using the Graphics2D transform
        g.draw(AWTGraphics.rotateShape(new Ellipse2D.Double(2 - rx * 0.5, 5 - ry * 0.5, rx, ry), -45 * Constant.DEG_TO_RAD));
        // Rotate 45 &ordm; using the original transform
        g.fill(AWTGraphics.rotateShape(g, new Ellipse2D.Double(2 - rx * 0.5, 5 - ry * 0.5, rx, ry), -45 * Constant.DEG_TO_RAD));
        g.drawLine(2, 5, 1, 2);
        p1.show("");

        /*
        // Quick simple chart example
        //CreateChart ch1bis = CreateChart.createSimpleChart(new double[] { 1, 2, 3 }, new double[] { 2, 4, 8 },
        //    "TITLE", "X_LABEL", "Y_LABEL", "LEGEND", false);
        ...
        SimpleChartElement chart2 = new SimpleChartElement(ChartElement.TYPE.CATEGORY_CHART,
                ChartElement.SUBTYPE.CATEGORY_BAR_3D, new double[] { 1, 2, 3 }, new double[] { 2, 4, 8 },
                "CHART 2", "X_LABEL", "Y_LABEL", "LEGEND", true, false, 400, 300);
        ...
        SimpleChartElement chart3 = new SimpleChartElement(ChartElement.TYPE.PIE_CHART,
                ChartElement.SUBTYPE.PIE_3D, new double[] { 1, 2, 3 }, new double[] { 2, 4, 8 },
                "CHART 3", "X_LABEL", "Y_LABEL", "LEGEND", true, false, 400, 300);
        ...
        ChartSeriesElement chartSeries1 = new ChartSeriesElement(vx, vy, null, null, "t_{kh}", true, Color.BLACK,
                ChartSeriesElement.SHAPE_EMPTY, ChartSeriesElement.REGRESSION.NONE);
        ChartSeriesElement chartSeries2 = new ChartSeriesElement(vx, y1, null, null, "dM/dt = 10^{-3} M_{@SUN}/a\u00f1o",
                true, Color.BLACK, ChartSeriesElement.SHAPE_EMPTY, ChartSeriesElement.REGRESSION.NONE);
        ChartSeriesElement chartSeries3 = new ChartSeriesElement(vx, y2, null, null, "dM/dt = 10^{-4}", true,
                Color.BLACK, ChartSeriesElement.SHAPE_EMPTY, ChartSeriesElement.REGRESSION.NONE);
        ChartSeriesElement chartSeries4 = new ChartSeriesElement(vx, y3, null, null, "dM/dt = 10^{-5}", true,
                Color.BLACK, ChartSeriesElement.SHAPE_EMPTY, ChartSeriesElement.REGRESSION.NONE);
        ...
        ChartSeriesElement series[] = new ChartSeriesElement[] { chartSeries1, chartSeries2, chartSeries3, chartSeries4 };
        ChartElement chart4 = new ChartElement(series, ChartElement.TYPE.XY_CHART, ChartElement.SUBTYPE.XY_SCATTER,
                "Acreci\u00f3n y tiempo de Kelvin-Helmholtz", "Masa de la estrella (M_{@SUN})", "Tiempo (a\u00f1os)", false, 802, 482);
        ...
        */
        ...
        ch4.exportAsScriptForGILDAS("myChart", CreateChart.GILDAS_LEYEND.BOTTOM);
        ...
        */
        ...
        do {
            ...
            if (elapsed >= 1.0) {
                ...
                ch1.getChartElement().series[0].regressionType = ChartSeriesElement.REGRESSION.LINEAR;
